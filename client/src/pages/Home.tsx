 ...
 * Event: Sábado 25 y Domingo 26 de Abril 2026 — Madrid
 */
...
export default function Home() {
  ...
  const STRIPE_URL = "https://buy.stripe.com/9B63cw84D5HQ4BQ4UdfIs02";
  ...
  const faqData = [
    ...
    },
    {
      ...
      a: "El evento se celebra el último fin de semana de abril 2026: sábado 25 y domingo 26 de abril. Dos días intensivos en un venue exclusivo en Madrid. Te recomendamos reservar tu plaza lo antes posible."
    },
    {
          ...
          <div className="max-w-3xl mx-auto space-y-3 mb-8">
            {[
              ...
              },
              {
                ...
                desc: "Preséntate el sábado 25 de abril en el venue exclusivo en Madrid. Todo está incluido.",
